...
export class InputService {
  private SINGLE_DIGIT_REGEX: RegExp = new RegExp(
    /^[0-9\u0660-\u0669\u06F0-\u06F9]$/
  );
  private ONLY_NUMBERS_REGEX: RegExp = new RegExp(
    /[^0-9\u0660-\u0669\u06F0-\u06F9]/g
  );
